...
plt3 = ggplot(aoidat, aes(y=meanSide, x=fixNum, colour=session))
plt3 = plt3 + geom_point(position=position_jitter(height=0.01, width=0.1))
plt3 = plt3 + geom_smooth(se=F)
plt3 = plt3 + scale_y_continuous(name="prop. of fixations on either side", expand=c(0,0), limits=c(-1,1), breaks=c(-1,-.5,0,.5,1), labels=c("100% left", "75% left", "50% balanced", "75% right", "100% right"))
plt3 = plt3 + scale_x_continuous(breaks=c(1,3,5, 7, 10))
